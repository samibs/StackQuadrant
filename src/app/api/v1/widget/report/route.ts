...
export async function POST(request: NextRequest) {
  try {
    ...
    const rl = rateLimit(`widget:report:${ip}`, 10, 3600000);
    if (!rl.success) {
    ...
    // Data quality-specific field validation
    ...
    console.error("POST /api/v1/widget/report error:", error);
