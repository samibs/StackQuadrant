...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const [updated] = await db.update(tools).set({
      ...
      ...(body.bestFor !== undefined && { bestFor: Array.isArray(body.bestFor) ? body.bestFor : [] }),
      ...(body.tags !== undefined && { tags: Array.isArray(body.tags) ? body.tags : [] }),
      ...(body.pricingModel !== undefined && { pricingModel: body.pricingModel || null }),
      ...(body.pricingTier !== undefined && { pricingTier: body.pricingTier || null }),
      ...(body.license !== undefined && { license: body.license || null }),
      ...(body.githubUrl !== undefined && { githubUrl: body.githubUrl || null }),
      ...(body.documentationUrl !== undefined && { documentationUrl: body.documentationUrl || null }),
      ...(body.githubStars !== undefined && { githubStars: body.githubStars || null }),
      ...(body.communitySize !== undefined && { communitySize: body.communitySize || null }),
      updatedAt: new Date(),
